...
public class Solution {
    ...
    public class TableInterfaceWrapper implements ATableInterface{
        ...
        private ATableInterface originalComponent;
        private String newHandlerText = null;
        ...
        public void setModel(List rows)
        {
            ...
            originalComponent.setModel(rows);
        }

        @Override
        public String getHeaderText()
        {
            return this.newHandlerText.toUpperCase();
        }

        @Override
        public void setHeaderText(String newHeaderText)
        {
            this.newHandlerText = newHeaderText;
            originalComponent.setHeaderText(newHeaderText);
        }
    }

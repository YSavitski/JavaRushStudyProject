...
public class Solution
{
    ...
    public static Map<String, Integer> countWords(ArrayList<String> list)
    {
        ...
        for (String listItem:
             list)
        {
            result.put(listItem, result.containsKey(listItem) ? result.get(listItem)+1 : 1);
        }
        return result;
    }

    public static ArrayList<String> getAllKeys(Map<String, Integer> map)
    {
        ArrayList<String> newArray = new ArrayList<String>();
        for (Map.Entry<String, Integer> item:
             map.entrySet())
        {
            newArray.add(item.getKey());
        }
        return newArray;
    }

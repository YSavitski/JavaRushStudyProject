...
public class Solution {
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            StringBuilder stringBuilder = new StringBuilder(ClassWithStatic.staticString);
            stringBuilder.append("\t" + Integer.toString(i) + "\t" + Integer.toString(j));
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            ClassWithStatic.staticString = elements[0];
            this.i = Integer.parseInt(elements[1]);
            this.j = Integer.parseInt(elements[2]);
            reader.close();
        }
    }
}

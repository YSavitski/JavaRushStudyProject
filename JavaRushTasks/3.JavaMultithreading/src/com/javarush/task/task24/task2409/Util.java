    ...
    public static List<Jeans> getAllJeans() {
        ...
        abstract class AbstractJeans implements Jeans{
            ...
            public String toString() {
                StringBuilder resultStr = new StringBuilder(super.getClass().getSimpleName());
                resultStr.append("{");
                resultStr.append("id=").append(id).append(", ");
                resultStr.append("length=").append(length).append(", ");
                resultStr.append("size=").append(size).append(", ");
                resultStr.append("price=").append(price);
                resultStr.append("}");

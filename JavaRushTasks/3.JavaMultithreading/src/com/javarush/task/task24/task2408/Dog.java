    ...
    public Sayable toSayable(final int i) {
       class DogPet extends SuperDog implements Sayable{
           private String getName(){
               StringBuilder nameInQuotes = new StringBuilder();
               nameInQuotes.append(super.getSuperQuotes());
               nameInQuotes.append(Dog.this.name);
               nameInQuotes.append(super.getSuperQuotes());
               return nameInQuotes.toString();
           }
           @Override
           public String say() {
               if(i<1){
                   ...
                   StringBuilder speaking = new StringBuilder(this.getName());
                   speaking.append(" лает г");
                   for(int j=0; j<i; j++){
                       speaking.append("a");
                   }
                   speaking.append("в! ");
                   speaking.append(super.formatter.format(new Date()));

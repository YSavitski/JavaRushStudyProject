...
*/
    ...
    public static class Calculation implements Callable<String>{
        private int inputNumber;
        private long resultCalculation;
        ...
        public String call() throws Exception {
            for (int i=1; i<=inputNumber; i++){
                resultCalculation += (long)i;
            }
            return String.valueOf(resultCalculation);
        }
    }
}
